package fr.valuu.app.repository;

import fr.valuu.app.PerempApp;
import fr.valuu.app.config.Constants;
import fr.valuu.app.config.audit.AuditEventConverter;
import fr.valuu.app.domain.PersistentAuditEvent;
...
import static fr.valuu.app.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
